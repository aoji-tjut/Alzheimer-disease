...
config["n_base_filters"] = 64  # these are doubled after each downsampling
...
def fetch_brats_2020_files(modalities, group="Train", include_truth=True, return_subject_ids=False):
